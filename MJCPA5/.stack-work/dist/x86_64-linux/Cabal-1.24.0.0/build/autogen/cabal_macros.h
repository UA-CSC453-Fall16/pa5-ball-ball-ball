...
/* package MJCPA5-0.1.0.0 */
#define VERSION_MJCPA5 "0.1.0.0"
#define MIN_VERSION_MJCPA5(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "MJCPA5-0.1.0.0"

#define CURRENT_PACKAGE_KEY "MJCPA5-0.1.0.0"
